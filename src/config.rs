...
pub const COLLECOTRS: Lazy<Vec<Collector>> = Lazy::new(|| vec![
    ...
    Collector::Raw("urska_m3_shard_general".into(), 7),
    Collector::Raw("urska_m3_shard_staff".into(), 7),
